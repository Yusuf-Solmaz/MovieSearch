...
class MovieRecyclerViewAdapter(private val movieList: ArrayList<Movie>, private val listener: Listener) :  RecyclerView.Adapter<MovieRecyclerViewAdapter.MovieHolder>(){
